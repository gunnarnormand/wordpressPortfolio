<?php
/**
 * Gunnar\'s Wordpress Theme functions and definitions.
 *
...
function gunnar_setup() {
	 ...
	 * If you're building a theme based on Gunnar\'s Wordpress Theme, use a find and replace
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'gunnar' ),
	) );
